...
app.post('/sendemail', (req, res) => {
    const {baarInput} = req.body; 

    const from = "hello@mafinancefacile.com";
    const to = req.body.baarInput;

    const subject = "Le guide l'investisseur #1"
    ...
    body {font-family: 'Muli', sans-serif;}
      ...
      <![endif]-->
        ...
        <tbody>
          <tr>
            <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
              <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="128" alt="" data-proportionally-constrained="true" data-responsive="false" src="http://cdn.mcauto-images-production.sendgrid.net/8e7c955294dcd2eb/2369d048-de08-4a5d-bb51-11f872cedd66/512x512.png" height="128">
            </td>
          </tr>
        </tbody>
        ...
        <tbody>
          <tr>
            <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Merci d'avoir souscris à notre Newsletter</span></div><div></div></div></td>
          </tr>
        </tbody>
      </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
        <tbody>
          <tr>
            <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Vous pouvez télécharger le guide de l'investisseur gratuitement en cliquant sur le lien ci-dessous;</span></div><div></div></div></td>
          </tr>
        </tbody>
            ...
            <tr>
              <td align="center" bgcolor="#ffffff" class="outer-td" style="padding:0px 0px 0px 0px; background-color:#ffffff;">
                <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                  <tbody>
                    <tr>
                    <td align="center" bgcolor="#08247f" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                      <a href="https://drive.google.com/file/d/10zBCCYDA7nBkKxiJmo25F2VsWU5fk1Mv/view?usp=sharing" style="background-color:#08247f; border:1px solid #08247F; border-color:#08247F; border-radius:0px; border-width:1px; color:#F9F9F9; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:16px 48px 16px 48px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">Télécharger</a>
                    </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <tbody>
          <tr>
            <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="08247F">
            </td>
          </tr>
        </tbody>
      </table></td>
